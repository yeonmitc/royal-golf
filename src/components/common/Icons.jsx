...
export function PencilIcon({ className, size = 16, strokeWidth = 1.5, color = 'currentColor' }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function SettingsIcon({ className, size = 16, strokeWidth = 1.5, color = 'currentColor' }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PaletteIcon({ className, size = 16, strokeWidth = 1.5, color = 'currentColor' }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
